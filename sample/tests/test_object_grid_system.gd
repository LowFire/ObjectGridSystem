...
class TestGridSpace2D extends GutTest:
	var grid_space: GridSpace2D
	
	func before_each() -> void:
		grid_space = GridSpace2D.new()
		#grid_space.object_removed.connect(_on_object_removed)
	...
	#func _on_object_removed(obj: GridObject2D, _id: int) -> void:
		#obj.free()
	...
	func test_add_object() -> void:
		var obj1: GridObject2D = GridObject2D.new()
	...
	func test_add_multiple_objects() -> void:
		var obj1: GridObject2D = GridObject2D.new()
		var obj2: GridObject2D = GridObject2D.new()
		var obj3: GridObject2D = GridObject2D.new()
		obj1.grid_bounds = Rect2i(1,1,1,1)
		obj2.grid_bounds = Rect2i(2,3,1,1)
		obj3.grid_bounds = Rect2i(4,4,1,1)
		var obj_arr: Array[GridObject2D] = [obj1, obj2, obj3]
		watch_signals(obj1)
		watch_signals(obj2)
		watch_signals(obj3)
		...
		for id in all_objects:
			var obj: GridObject2D = all_objects[id]
	...
	func test_get_all_objects() -> void:
		var obj1: GridObject2D = GridObject2D.new()
		var obj2: GridObject2D = GridObject2D.new()
		var obj_arr: Array[GridObject2D] = [obj1, obj2]
	...
	func test_object_added_signal() -> void:
		var callback: Callable = func(obj: GridObject2D, id: int) -> void:
			assert_ne(obj, null)
			assert_eq(id, 0)
		grid_space.object_added.connect(callback)
		
		var obj : GridObject2D = GridObject2D.new()
	...
	func test_remove_all_objects() -> void:
		var obj_arr: Array[GridObject2D] = [GridObject2D.new(), GridObject2D.new(), GridObject2D.new()]
		grid_space.add_objects(obj_arr)
	...
	func test_get_object_by_id() -> void:
		...
		var result: GridObject2D = grid_space.get_object_by_id(id)
	...
	func test_object_is_overlapping() -> void:
		...
		var obj2: GridObject2D = GridObject2D.new()
		var obj3: GridObject2D = GridObject2D.new()
		var obj4: GridObject2D = GridObject2D.new()
...
class TestGridObject2D extends GutTest:
	var grid_object: GridObject2D
	
	func before_each() -> void:
		grid_object = GridObject2D.new()
	...
	func test_grid_dimensions_signal() -> void:
		var callback: Callable = func (obj: GridObject2D, old_dimensions: Vector2i, new_dimensions: Vector2i) -> void:
			assert_ne(obj, null)
			assert_eq(old_dimensions, Vector2i(1,1))
			assert_eq(new_dimensions, Vector2i(2,2))
	...
	func test_grid_position_changed_signal() -> void:
		var callback: Callable = func (obj: GridObject2D, old_position: Vector2i, new_position: Vector2i) -> void:
			assert_ne(obj, null)
			assert_eq(old_position, Vector2i(0,0))
	...
	func test_signals_emit_on_grid_bounds_changed() -> void:
		var dimensions_changed_callback: Callable = func (obj: GridObject2D, old_dimensions: Vector2i, new_dimensions: Vector2i) -> void:
			assert_ne(obj, null)
			assert_eq(old_dimensions, Vector2i(1,1))
			assert_eq(new_dimensions, Vector2i(2,2))
		var position_changed_callback: Callable = func (obj: GridObject2D, old_position: Vector2i, new_position: Vector2i) -> void:
			assert_ne(obj, null)
			assert_eq(old_position, Vector2i(0,0))
			assert_eq(new_position, Vector2i(2,2))
